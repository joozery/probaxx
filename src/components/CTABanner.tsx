...
export default function CTABanner({ data }: { data: IHomeSettings['cta'] }) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-600 text-sm">{data.hoursLabel}</p>
                <p className="text-[#0a1628] font-extrabold text-lg leading-tight">{data.hours}</p>
              </div>
            </div>
