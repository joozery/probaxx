...
export default function WhyServiceSection() {
  const benefits = [
    {
      title: 'สุขภาพดี',
      desc: 'ลดความเสี่ยงในการเกิดโรค',
      icon: (
    ...
    {
      title: 'น้ำใส สะอาด',
      desc: 'ปลอดภัยต่อการอุปโภคบริโภค',
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: 'ยืดอายุการใช้งาน',
      desc: 'ของถังและระบบน้ำ',
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      desc: 'ลดปัญหาการอุดตัน และซ่อมบำรุง',
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
          ...
          <div className="lg:w-[45%] xl:w-[40%] bg-white/40 lg:bg-transparent backdrop-blur-sm lg:backdrop-blur-none p-6 lg:p-0 rounded-3xl">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#0a1628] leading-tight mb-3">
              ทำไมต้องล้างถังเก็บน้ำ<br />
              <span className="text-[#1d4ed8]">อย่างน้อยทุก 6 เดือน?</span>
            </h2>
            <p className="text-gray-600 font-medium text-sm lg:text-base leading-relaxed mb-8 pr-4">
              ถังเก็บน้ำที่ไม่ได้รับการดูแล จะเป็นแหล่งสะสมของ
              ตะกอน สิ่งสกปรก แบคทีเรีย และเชื้อโรคต่างๆ
              ซึ่งส่งผลกระทบต่อสุขภาพของคุณและคนในครอบครัว
            </p>
