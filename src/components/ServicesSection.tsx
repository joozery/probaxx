...
const services = [
  {
    title: 'ล้างถังเก็บน้ำ',
    desc: 'ล้างทำความสะอาดถังเก็บน้ำบนดินและใต้ดิน ทุกขนาด เพื่อความสะอาดและปลอดภัย',
    icon: (
    ...
    image: '/article/service_tank_cleaning.png',
  },
  {
    title: 'ล้างถังบำบัดน้ำเสีย',
    desc: 'บริการสูบสิ่งปฏิกูลและทำความสะอาดถังบำบัดน้ำเสีย ขจัดกลิ่นเหม็นสะสม',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m3.75 9v6m3-3H9m1.5-12H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
      </svg>
    ),
    image: '/article/service_wastewater_tank.png',
  },
  {
    title: 'ระบบบำบัดน้ำเสีย',
    desc: 'ออกแบบ ติดตั้ง และปรับปรุงระบบบำบัดน้ำเสียให้ได้มาตรฐาน เป็นมิตรต่อสิ่งแวดล้อม',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    image: '/article/service_wastewater_system.png',
  },
  {
    title: 'ผู้ควบคุมระบบบำบัดน้ำเสีย',
    desc: 'บริการดูแลและเดินระบบบำบัดน้ำเสียโดยผู้เชี่ยวชาญเฉพาะทางที่ได้รับใบอนุญาต',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    image: '/article/service_wastewater_operator.png',
  }
]
            ...
            >
              ...
              <div className="flex justify-start px-8 -mt-8 relative z-10 mb-2">
                <div className="w-16 h-16 bg-[#1d4ed8] text-white rounded-full flex items-center justify-center shadow-lg border-[3px] border-white">
                  <span className="[&>svg]:w-7 [&>svg]:h-7">{srv.icon}</span>
                </div>
              </div>
