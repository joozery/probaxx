const steps = [
  {
    ...
    desc: 'สำรวจหน้างานและ ตรวจสอบอุปกรณ์เบื้องต้น',
  },
  {
    num: '02',
    icon: (
    ...
    title: 'วางแผนการทำงาน',
    desc: 'วางแผนและเตรียมอุปกรณ์ สารเคมีและอุปกรณ์ล้าง',
  },
  {
    num: '03',
    icon: (
    ...
    title: 'ล้างทำความสะอาด',
    desc: 'ล้างตะกอน สิ่งปนเปื้อน และสิ่งปนเปื้อนอย่างละเอียด',
  },
  {
    num: '04',
    icon: (
    ...
    desc: 'ตรวจสอบคุณภาพน้ำ ก่อน-หลังล้าง',
  },
  {
    num: '05',
    icon: (
    ...
    title: 'สรุปรายงานผล',
    desc: 'สรุปรายงานผล พร้อมรายงานการตรวจสอบ',
  },
  {
    num: '06',
    icon: (
    ...
    desc: 'ติดตามผล แก้ไขปัญหา และพร้อมให้บริการ',
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0a1628]">
            มาตรฐานการให้บริการ
            <span className="text-[#f97316]">ของเรา</span>
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 relative">
          {steps.map((step, i) => (
            <div key={i} className="flex flex-col items-center text-center relative">
              {/* Arrow between steps */}
              {i < steps.length - 1 && (
                <div className="hidden lg:flex absolute right-0 top-1/4 translate-x-1/2 -translate-y-1/2 z-10 text-gray-300">
              ...
              <span className="text-[#f97316] font-bold text-sm mb-1">{step.num}</span>
