...
const benefits = [
  {
    ...
    title: 'ความสะอาด',
    desc: 'ขจัดตะกอนสกปรก แบคทีเรีย และสิ่งปนเปื้อนในน้ำให้หมดจด',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: 'คุณภาพน้ำ',
    desc: 'น้ำสะอาด ปลอดภัย เหมาะสำหรับการอุปโภคและบริโภคทุกวัน',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: 'ลดตะกอน',
    desc: 'ลดการสะสมของตะกอน สิ่งสกปรก และตะไคร่ภายในถัง',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: 'ยืดอายุระบบ',
    desc: 'ยืดอายุการใช้งานถังและระบบน้ำ ให้ทำงานได้ยาวนานขึ้น',
  },
]
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#0a1628] leading-tight mb-4">
              ทำไมต้อง<br />
              <span className="text-[#f97316]">ล้างถังเก็บน้ำ</span><br />
              เป็นประจำ?
            </h2>

            <p className="text-gray-600 text-base leading-relaxed mb-8 max-w-md">
              การล้างถังเก็บน้ำและถังบำบัดน้ำเสียอย่างสม่ำเสมอ
              ช่วยให้ระบบน้ำทำงานได้อย่างมีประสิทธิภาพ
              น้ำสะอาดปลอดภัย และยืดอายุการใช้งานของระบบ
            </p>

            {/* Stats */}
            <div className="flex gap-8">
              <div>
                <p className="text-3xl font-extrabold text-[#f97316]">10+</p>
                <p className="text-gray-500 text-sm mt-0.5">ปีประสบการณ์</p>
              </div>
              <div className="w-px bg-gray-200" />
              <div>
                <p className="text-3xl font-extrabold text-[#f97316]">500+</p>
                <p className="text-gray-500 text-sm mt-0.5">โปรเจกต์สำเร็จ</p>
              </div>
              <div className="w-px bg-gray-200" />
              <div>
                <p className="text-3xl font-extrabold text-[#f97316]">100%</p>
                <p className="text-gray-500 text-sm mt-0.5">ลูกค้าพึงพอใจ</p>
              </div>
            </div>
          </div>
