              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {articles.map((article) => (
                  <Link
                    ...
                    className="group flex flex-col rounded-2xl overflow-hidden bg-white border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1.5 hover:border-blue-200"
                  >
                    <div className="relative h-56 overflow-hidden bg-gray-100">
                      ...
                      <span className={`absolute top-4 left-4 text-white text-[11px] font-semibold px-3 py-1 rounded-full shadow-sm ${CAT_COLORS[article.category] ?? 'bg-blue-600'}`}>
                        {article.category}
                      </span>
                    </div>

                    <div className="flex flex-col flex-1 p-6">
                      <h2 className="font-bold text-[#0a1628] text-xl leading-snug mb-3 group-hover:text-[#1d4ed8] transition-colors duration-300">
                        {article.title}
                      </h2>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                        ...
                        <span className="text-blue-600 text-xs font-semibold flex items-center gap-1 opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-300">
                          อ่าน
                          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
